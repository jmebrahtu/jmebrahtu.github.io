...
//3...function Constructor
    ...
    const teacher = new Person("Dr. Aron Gdi");
...
// 4..b....function Constructor Aproach
    ...
    const Studet = new Perrson("Jirom", 27);
    Studet.major = "WAP";
    Studet.greeting = function () {
        return "Hey my name is " + this.name + " and I am studying " + this.major
    };
    console.log(Studet.greeting());
    const Profesor = new Perrson("Dr. Aron Gdi", 56);
    ...
    describe("Defer function", function () {
        it("calling f() should return Maharishi", function () {
            assert.equal(bubleSort([2,-2,6,7,7,4]).toString(), "-2,2,4,6,7,7")
        });
    });
